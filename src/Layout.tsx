    ...
    <footer className="relative bg-[#0A0F1A] text-white py-16 overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto px-4 text-center z-10">
        ...
        <h3 className="text-xl md:text-2xl font-bold text-[#C7A055] mb-6">
          Learn • Build • Earn with Sameer
        </h3>

        {/* Social Icons */}
        <div className="flex justify-center space-x-8 mb-8">
          <a
            href="https://www.instagram.com/hustlewithsameer._"
            target="_blank"
        ...
        <p className="text-sm text-gray-400">
          © 2026 Sameer Suthar | All Rights Reserved.
        </p>
        <p className="text-sm text-[#C7A055] font-semibold mt-1 tracking-wide">
          Powered by <span className="text-white">StraviX</span>
        </p>
      </div>
    </footer>
  );
